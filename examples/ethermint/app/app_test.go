...
func newEthermintApp() *EthermintApp {
	...
	return NewEthermintApp(logger, dbs)
}

func setGenesisAccounts(bapp *EthermintApp, accs ...auth.BaseAccount) error {
...
func TestSortGenesis(t *testing.T) {
	logger, dbs := loggerAndDBs()
	bapp := NewEthermintApp(logger, dbs)
...
func SignCheckDeliver(t *testing.T, bapp *EthermintApp, msg sdk.Msg, seq []int64, expPass bool, priv ...crypto.PrivKeyEd25519) {
...
func CheckBalance(t *testing.T, bapp *EthermintApp, addr sdk.Address, balExpected string) {
